 ...
 * @@Modify Date: 2016-07-08 14:09:40
 * @@Function:
 */
	...
	define([
	            ...
	            productSlider : function(options, el) {
         			if(jQuery().slick) {
						if(el.hasClass('slick-initialized')) el.slick("refresh"); // slide.resize(); // $(window).trigger('resize');
			 			...
			 			console.log('Slick not loaded please go to Stores > Configuration > Advanced > Developer > JavaScript Settings > Merge JavaScript Files > Yes');
		...
		require([
				...
				'magiccart/slick',
					...
					(function($) {
			    jQuery("*[class^='alo-content-']").each(function() {
