<?php
namespace Kikinben\cartPopup\Block\Product\View;

/**
 * Interceptor class for @see \Kikinben\cartPopup\Block\Product\View
 */
class Interceptor extends \Kikinben\cartPopup\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getRelatedProductCollection($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRelatedProductCollection($id);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductImageDetails');
        if (!$pluginInfo) {
            return parent::getProductImageDetails($id);
        } else {
            return $this->___callPlugins('getProductImageDetails', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductName($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductName($id);
        } else {
