...
class Interceptor extends \Apptha\Marketplace\Controller\Assignproduct\Cart\Add implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Framework\Data\Form\FormKey\Validator $formKeyValidator, \Magento\Framework\App\Request\Http $request, \Magento\Checkout\Model\Cart $cart, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository)
    {
        $this->___init();
        parent::__construct($context, $scopeConfig, $checkoutSession, $storeManager, $formKeyValidator, $request, $cart, $productRepository);
    }
    ...
    public function getProductStockData($productId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductStockData($productId);
        } else {
            return $this->___callPlugins('getProductStockData', func_get_args(), $pluginInfo);
        }
    }
