<?php
namespace Apptha\Marketplace\Model\Session;

/**
 * Interceptor class for @see \Apptha\Marketplace\Model\Session
 */
class Interceptor extends \Apptha\Marketplace\Model\Session implements \Magento\Framework\Interception\InterceptorInterface
{
