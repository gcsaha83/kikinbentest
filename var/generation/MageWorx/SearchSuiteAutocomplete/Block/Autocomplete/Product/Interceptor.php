...
class Interceptor extends \MageWorx\SearchSuiteAutocomplete\Block\Autocomplete\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Helper\Product $catalogHelperProduct, \Magento\Framework\Stdlib\StringUtils $string, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\Data\Form\FormKey $formKey, \Magento\Catalog\Block\Product\Context $context, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSmallImage');
        if (!$pluginInfo) {
            return parent::getSmallImage();
        } else {
            return $this->___callPlugins('getSmallImage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReviewsRating');
        if (!$pluginInfo) {
            return parent::getReviewsRating();
        } else {
            return $this->___callPlugins('getReviewsRating', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShortDescription');
        if (!$pluginInfo) {
            return parent::getShortDescription();
        } else {
            return $this->___callPlugins('getShortDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddToCartData');
        if (!$pluginInfo) {
            return parent::getAddToCartData();
        } else {
            return $this->___callPlugins('getAddToCartData', func_get_args(), $pluginInfo);
        }
    }
