...
class Interceptor extends \Magiccart\Magicproduct\Block\Category\GridProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBestseller');
        if (!$pluginInfo) {
            return parent::getBestseller($collection);
        } else {
            return $this->___callPlugins('getBestseller', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeatured');
        if (!$pluginInfo) {
            return parent::getFeatured($collection);
        } else {
            return $this->___callPlugins('getFeatured', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLatest');
        if (!$pluginInfo) {
            return parent::getLatest($collection);
        } else {
            return $this->___callPlugins('getLatest', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMostviewed');
        if (!$pluginInfo) {
            return parent::getMostviewed($collection);
        } else {
            return $this->___callPlugins('getMostviewed', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNew');
        if (!$pluginInfo) {
            return parent::getNew($collection);
        } else {
            return $this->___callPlugins('getNew', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRandom');
        if (!$pluginInfo) {
            return parent::getRandom($collection);
        } else {
            return $this->___callPlugins('getRandom', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSale');
        if (!$pluginInfo) {
            return parent::getSale($collection);
        } else {
            return $this->___callPlugins('getSale', func_get_args(), $pluginInfo);
        }
    }
