...
class Interceptor extends \Magiccart\Magicproduct\Block\Product\GridProduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTypeFilter');
        if (!$pluginInfo) {
            return parent::getTypeFilter();
        } else {
            return $this->___callPlugins('getTypeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetCfg');
        if (!$pluginInfo) {
            return parent::getWidgetCfg($cfg);
        } else {
            return $this->___callPlugins('getWidgetCfg', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBestsellerProducts');
        if (!$pluginInfo) {
            return parent::getBestsellerProducts();
        } else {
            return $this->___callPlugins('getBestsellerProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeaturedProducts');
        if (!$pluginInfo) {
            return parent::getFeaturedProducts();
        } else {
            return $this->___callPlugins('getFeaturedProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLatestProducts');
        if (!$pluginInfo) {
            return parent::getLatestProducts();
        } else {
            return $this->___callPlugins('getLatestProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMostviewedProducts');
        if (!$pluginInfo) {
            return parent::getMostviewedProducts();
        } else {
            return $this->___callPlugins('getMostviewedProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewProducts');
        if (!$pluginInfo) {
            return parent::getNewProducts();
        } else {
            return $this->___callPlugins('getNewProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRandomProducts');
        if (!$pluginInfo) {
            return parent::getRandomProducts();
        } else {
            return $this->___callPlugins('getRandomProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRecentlyProducts');
        if (!$pluginInfo) {
            return parent::getRecentlyProducts();
        } else {
            return $this->___callPlugins('getRecentlyProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaleProducts');
        if (!$pluginInfo) {
            return parent::getSaleProducts();
        } else {
            return $this->___callPlugins('getSaleProducts', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSpecialProducts');
        if (!$pluginInfo) {
            return parent::getSpecialProducts();
        } else {
            return $this->___callPlugins('getSpecialProducts', func_get_args(), $pluginInfo);
        }
    }
