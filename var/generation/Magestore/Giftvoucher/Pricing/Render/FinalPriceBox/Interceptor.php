<?php
namespace Magestore\Giftvoucher\Pricing\Render\FinalPriceBox;

/**
 * Interceptor class for @see \Magestore\Giftvoucher\Pricing\Render\FinalPriceBox
 */
class Interceptor extends \Magestore\Giftvoucher\Pricing\Render\FinalPriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMaximalGiftPrice');
        if (!$pluginInfo) {
            return parent::getMaximalGiftPrice();
        } else {
            return $this->___callPlugins('getMaximalGiftPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMinimalGiftPrice');
        if (!$pluginInfo) {
            return parent::getMinimalGiftPrice();
        } else {
            return $this->___callPlugins('getMinimalGiftPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultGiftPrice');
        if (!$pluginInfo) {
            return parent::getDefaultGiftPrice();
        } else {
            return $this->___callPlugins('getDefaultGiftPrice', func_get_args(), $pluginInfo);
        }
    }
