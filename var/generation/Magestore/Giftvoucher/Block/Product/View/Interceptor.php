<?php
namespace Magestore\Giftvoucher\Block\Product\View;

/**
 * Interceptor class for @see \Magestore\Giftvoucher\Block\Product\View
 */
class Interceptor extends \Magestore\Giftvoucher\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Stdlib\ArrayUtils $arrayUtils, \Magento\Catalog\Helper\Product $catalogProduct, \Magestore\Giftvoucher\Helper\Giftproduct $helperData, \Magestore\Giftvoucher\Helper\Data $giftvoucherData, \Magento\Framework\ObjectManagerInterface $objectManager, \Magestore\Giftvoucher\Model\Product\PriceFactory $productPrice, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Framework\Pricing\PriceCurrencyInterface $priceCurrency, \Magento\Framework\Locale\FormatInterface $localeFormat, \Magento\Framework\DataObject $dataObject, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $arrayUtils, $catalogProduct, $helperData, $giftvoucherData, $objectManager, $productPrice, $jsonEncoder, $priceCurrency, $localeFormat, $dataObject, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGiftAmount');
        if (!$pluginInfo) {
            return parent::getGiftAmount($product);
        } else {
            return $this->___callPlugins('getGiftAmount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function convertPrice($product, $price)
    {
        ...
        if (!$pluginInfo) {
            return parent::convertPrice($product, $price);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'messageMaxLen');
        if (!$pluginInfo) {
            return parent::messageMaxLen();
        } else {
            return $this->___callPlugins('messageMaxLen', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'enablePhysicalMail');
        if (!$pluginInfo) {
            return parent::enablePhysicalMail();
        } else {
            return $this->___callPlugins('enablePhysicalMail', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormConfigData');
        if (!$pluginInfo) {
            return parent::getFormConfigData();
        } else {
            return $this->___callPlugins('getFormConfigData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'enableScheduleSend');
        if (!$pluginInfo) {
            return parent::enableScheduleSend();
        } else {
            return $this->___callPlugins('enableScheduleSend', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGiftAmountDescription');
        if (!$pluginInfo) {
            return parent::getGiftAmountDescription();
        } else {
            return $this->___callPlugins('getGiftAmountDescription', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAvailableTemplate');
        if (!$pluginInfo) {
            return parent::getAvailableTemplate();
        } else {
            return $this->___callPlugins('getAvailableTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceFormatJs');
        if (!$pluginInfo) {
            return parent::getPriceFormatJs();
        } else {
            return $this->___callPlugins('getPriceFormatJs', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isInConfigurePage');
        if (!$pluginInfo) {
            return parent::isInConfigurePage();
        } else {
            return $this->___callPlugins('isInConfigurePage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'contentCondition');
        if (!$pluginInfo) {
            return parent::contentCondition();
        } else {
            return $this->___callPlugins('contentCondition', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGiftvoucherHelper');
        if (!$pluginInfo) {
            return parent::getGiftvoucherHelper();
        } else {
            return $this->___callPlugins('getGiftvoucherHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRequestInterface');
        if (!$pluginInfo) {
            return parent::getRequestInterface();
        } else {
            return $this->___callPlugins('getRequestInterface', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreManager()
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreManager();
        } else {
            return $this->___callPlugins('getStoreManager', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getJsonEncode');
        if (!$pluginInfo) {
            return parent::getJsonEncode();
        } else {
            return $this->___callPlugins('getJsonEncode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxHelper');
        if (!$pluginInfo) {
            return parent::getTaxHelper();
        } else {
            return $this->___callPlugins('getTaxHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCatalogHelper');
        if (!$pluginInfo) {
            return parent::getCatalogHelper();
        } else {
            return $this->___callPlugins('getCatalogHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getObjectManager()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getObjectManager', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceCurrency');
        if (!$pluginInfo) {
            return parent::getPriceCurrency();
        } else {
            return $this->___callPlugins('getPriceCurrency', func_get_args(), $pluginInfo);
        }
    }
